...
class StResponse extends StatefulWidget {
  const StResponse({super.key});

  @override
  State<StResponse> createState() => _StResponseState();
}

class _StResponseState extends State<StResponse> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Response')),
