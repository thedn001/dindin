...
import 'package:dindin_app/reportview.dart';
...
class Navadmin extends StatefulWidget {
  ...
  @override
  State<Navadmin> createState() => _NavbarState();
}

class _NavbarState extends State<Navadmin> {
  bool light0 = true;
  bool light1 = true;
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (context, animation,
                                          secondaryAnimation) =>
                                      const StResponse(), // ไป StResponse
                                  transitionsBuilder: (context, animation,
                                      secondaryAnimation, child) {
                                    const begin = Offset(0.0,
                                        1.0); // (x, y) 1.0 = เลื่อนจากล่างขึ้นมา
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (context, animation,
                                          secondaryAnimation) =>
                                      const StBookmark(), // ไป StBookmark
                                  transitionsBuilder: (context, animation,
                                      secondaryAnimation, child) {
                                    const begin = Offset(0.0,
                                        1.0); // (x, y) 1.0 = เลื่อนจากล่างขึ้นมา
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              PageRouteBuilder(
                                  ...
                                  pageBuilder: (context, animation,
                                          secondaryAnimation) =>
                                      const Reportview(), // ไป reportview
                                  transitionsBuilder: (context, animation,
                                      secondaryAnimation, child) {
                                    const begin = Offset(0.0,
                                        1.0); // (x, y) 1.0 = เลื่อนจากล่างขึ้นมา
